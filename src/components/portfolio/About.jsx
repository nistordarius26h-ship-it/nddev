        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-8 lg:col-start-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 inline-block mono text-[10px] uppercase tracking-[0.15em] text-white/30 hover:text-white/70 transition-colors"
            >
              Full certificate & skill history on LinkedIn →
            </a>
          </div>
        </div>
      </div>
